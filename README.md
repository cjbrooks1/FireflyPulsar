...
\textbf{Important to note is that the X,Y,Z coordinates are defined with Earth being at 0,0,0.}
...
\textbf{If you decide to search for multiple weights, list the weights seperated by a coma and no space. No need to include square brackets or parenthesis.}
...
\textbf{The files will be saved as .txt files  and .png files within the directory that the code is executed in.}
